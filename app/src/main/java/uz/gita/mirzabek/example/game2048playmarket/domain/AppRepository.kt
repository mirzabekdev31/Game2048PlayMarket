package uz.gita.mirzabek.example.game2048playmarket.domain
...
class AppRepository(ctx:Context) {
    ...
    private val appPref:AppPref=AppPref(ctx)
    private var score:Int=0

    init {
        appPref.getCurrentPos()
        addNewElement()
        addNewElement()
    }
    ...
    fun saveData(currentData:Int){
        appPref.setPos(matrix)
        //appPref.score=currentData.toString()
    }
